"""Correctness smoke test for the gathered PagedAttention milestone."""
...
def build_engine(device: torch.device, *, warmup: bool = False) -> InferenceEngine:
...
class EngineSmokeTest(unittest.TestCase):
    def test_requests_finish_and_pages_are_released(self) -> None:
